...
contract StdChainsTest is Test {
    function test_ChainRpcInitialization() public {
        ...
        assertEq(getChain(1337).rpcUrl, "http://127.0.0.1:8545");
    ...
    function test_SetChainFirstFails() public {
        ...
        vm.expectRevert("StdChains setChain(string,ChainData): Chain ID 1337 already used by \"anvil\".");
        stdChainsMock.exposed_setChain("anvil2", ChainData("Anvil", 1337, "URL"));
    }
    ...
    function test_DontUseDefaultRpcUrl() public {
        ...
        vm.expectRevert();
        stdChainsMock.exposed_getChain(1337);
        vm.expectRevert();
